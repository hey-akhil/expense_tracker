...
<header>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top">
        <h3 class="navbar-brand" style="font-size: 1.5rem; color: #ffffff; margin-top: 8px;">
            𝐄𝐗𝐏𝐄𝐍𝐒𝐄 𝐓𝐑𝐀𝐂𝐊𝐄𝐑
        </h3>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <?php if (isset($_SESSION['user_id'])): ?>
                    <li class="nav-item">
                        <a href="<?php echo ($_SESSION['role'] === 'admin') ? 'admin_dashboard.php' : 'user_dashboard.php'; ?>" class="nav-link">Dashboard
                        <!--<i class="fas fa-home" style="margin-top: 3px;"></i>  -->
                        </a>
                    </li>
